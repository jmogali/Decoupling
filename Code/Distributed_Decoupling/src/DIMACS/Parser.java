...
public class Parser {
	...
	protected HashMap<String, User_Defined_Constraint> m_hmp_Edge_Weights = null; // String format: Owner1_Owner2
	protected HashMap<String , Boolean> m_hmp_Vtx_Shared = null;
	...
	public Parser()
	{
		...
		m_hmp_Edge_Weights = new HashMap<String, User_Defined_Constraint>();
		m_hmp_Vtx_Shared = new HashMap<String, Boolean>();
	...
	private void SetConstraintValue(String[] words , int iLineNum)
	{
		...
		{
			m_hmp_Vtx_Shared.put(strVtx1, true);
			m_hmp_Vtx_Shared.put(strVtx2, true);
		}
		
		m_hmp_Edge_Weights.put( strOwner1+"_"+strOwner2, new User_Defined_Constraint(strConsName, strVtx1, strVtx2, dConstraint));
	}
